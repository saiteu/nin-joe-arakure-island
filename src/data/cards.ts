...
export const rewardCardPool: Card[] = [
  ...
  { id: "stone-throw", name: "投石", cost: 0, type: "attack", category: "ranged", rarity: "common", description: "敵に1ダメージ。間合いを変えない。", damage: 1, ranged: true },
  ...
  { id: "tile-throw", name: "瓦投げ", cost: 1, type: "attack", category: "ranged", rarity: "uncommon", description: "敵に2ダメージ。コンボ中なら4ダメージ。間合いを変えない。", damage: 2, comboDamage: 4, ranged: true },
