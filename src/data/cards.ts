...
export const rewardCardPool: Card[] = [
  { id: "heel-drop", name: "踵落とし", cost: 2, type: "attack", category: "knockback", rarity: "uncommon", description: "敵に8ダメージ。コンボ中なら12ダメージ。ノックバック。", damage: 8, comboDamage: 12, knockback: true },
  { id: "stone-throw", name: "投石", cost: 0, type: "attack", category: "ranged", rarity: "common", description: "敵ブロックを2崩す。敵に1ダメージ。間合いを変えない。", damage: 1, blockBreak: 2, ranged: true },
  ...
  { id: "body-sweep", name: "胴払い", cost: 2, type: "attack", category: "melee", rarity: "common", description: "敵に6ダメージ。ブロックを4得る。コンボ中なら9ダメージ、ブロック6。", damage: 6, comboDamage: 9, block: 4, comboBlock: 6 },
  ...
  { id: "shoulder-check", name: "鉄肩", cost: 1, type: "attack", category: "knockback", rarity: "uncommon", description: "敵に4ダメージ。コンボ中なら6ダメージ。ノックバック。", damage: 4, comboDamage: 6, knockback: true },
  { id: "belly-breath", name: "腹式呼吸", cost: 1, type: "skill", category: "spirit", rarity: "uncommon", description: "ブロックを3得て、胆力を1回復。コンボ中ならブロック5。", block: 3, comboBlock: 5, spiritGain: 1 },
